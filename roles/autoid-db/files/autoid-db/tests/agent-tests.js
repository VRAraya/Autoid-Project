...
const { agentFixtures } = require('autoid-utils')
...
test.beforeEach(async () => {
  ...
  AgentStub.findAll
    ...
    .returns(Promise.resolve(agentFixtures.originalTest))
...
test.serial('Agent#findAll', async t => {
  ...
  t.is(
    ...
    'agent should be the same amount'
  )
...
test.serial('Agent#findByUsername', async t => {
  ...
  t.is(
    agents.length,
    agentFixtures.originalTest.length,
    'agents should be the same amount'
  )
